...
#    hists.Add('preTagDenominator',selection.a.DataFrame.Histo2D(('preTagDenominator','',16,25,825,24,625,3025),'Smass_trig','mth_trig'))
    ...
    hists.Add('preTagDenominatorHT',selection.a.DataFrame.Histo1D(('preTagDenominatorHT','',30,25,3025),'HT'))
    hists.Add('preTagDenominatorTpt',selection.a.DataFrame.Histo1D(('preTagDenominatorTpt','',30,25,3025),'pt0'))
...
#    hists.Add('preTagNumerator',selection.a.DataFrame.Histo2D(('preTagNumerator','',16,25,825,24,625,3025),'Smass_trig','mth_trig'))
    ...
    hists.Add('preTagNumeratorHT',selection.a.DataFrame.Histo1D(('preTagNumeratorHT','',30,25,3025),'HT'))
    hists.Add('preTagNumeratorTpt',selection.a.DataFrame.Histo1D(('preTagNumeratorTpt','',30,25,3025),'pt0'))
...
#    hists.Draw("colz")
    ...
    h_efficiencyT = ROOT.TGraphAsymmErrors()
    h_efficiencyT.Divide(hists['preTagNumeratorTpt'],hists['preTagDenominatorTpt'])
    h_efficiencyA = ROOT.TGraphAsymmErrors()
    h_efficiencyA.Divide(hists['preTagNumeratorApt'],hists['preTagDenominatorApt'])

    out = ROOT.TFile.Open('THtrigger2D_HT{}_{}_StoAA100x100.root'.format(HT,year), 'RECREATE')
    out.cd()
