import ROOT
f = ROOT.TFile.Open('/uscms/home/dpilipov/nobackup/TwoDAlphabet/CMSSW_10_6_14/src/rootfiles/THselection_mvaID_HT900_VJets_16APV.root','read')
# get the histos
...
h1.SetTitle("2016APV VJets 2t-2a; M_{\gamma\gamma}; M_{t\gamma\gamma}")
h2.SetTitle("2016APV VJets 2t-1a; M_{\gamma\gamma}; M_{t\gamma\gamma}")
h3.SetTitle("2016APV VJets 2t-0a; M_{\gamma\gamma}; M_{t\gamma\gamma}")
h4.SetTitle("2016APV VJets 1t-2a; M_{\gamma\gamma}; M_{t\gamma\gamma}")
h5.SetTitle("2016APV VJets 1t-1a; M_{\gamma\gamma}; M_{t\gamma\gamma}")
h6.SetTitle("2016APV VJets 1t-0a; M_{\gamma\gamma}; M_{t\gamma\gamma}")
...
c.Print("outputSelectionVJets_16APV_HT900.pdf")  # save it to the pdf
