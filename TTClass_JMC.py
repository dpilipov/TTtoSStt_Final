...
#        self.a.Define('mth','topchoice*mth1+(1-topchoice)*mth2')
        ...
        self.a.Define('dR1','hardware::DeltaR(Top2_vect,gen_vect)')
#DP EDIT INSTEAD THIS IS USED FOR SIGNAL - TURN OFF WHEN NOT USING SIGNAL -GEN!!!
        self.a.Define('topchoiceX','int(dR1<dR0)')
        self.a.Define('mthX','topchoiceX*mth1+(1-topchoiceX)*mth2')
#        self.a.Define('topIDcorrect','topchoice==topchoiceX')
        self.a.Define('topIDcorrect','topchoice2==topchoiceX')
