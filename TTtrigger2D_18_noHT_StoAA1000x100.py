...
#    else:
    fName = 'dijet_nano/StoAA1000x100_18_snapshot.txt'
...
#    yesTag = selection.a.Cut('posttrig','(HLT_DoublePhoton70==1) || (HLT_DoublePhoton85==1)')
...
#        f = ROOT.TF2("eff_func","1-exp(-[0]+[1]*y/1000)*exp([2]*x/50)",25,825,25,3025)
        f = ROOT.TF2("eff_func","1-[0]/10*exp(-[1]*y/1000)*exp(0.07*x/50)",25,825,25,3025)
