import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1500x100_16.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1500x200_16.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1500x300_16.root','read')
# get the histos
...
c.Print("outputSelection1500M_mvaID_16.pdf")  # save it to the pdf
