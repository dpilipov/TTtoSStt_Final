...
#    	"QCDHT700"	: "QCD",
    	...
    	"StoAA"         : "signal 1000/200"	# used to concatenate the 4 QCD processes
}
...
#        'deltaphi'               : '#Delta#phi_{jet0,jet1}',
        'deltaEta'                : '#Delta#eta_{#gamma 0,#gamma 1}',
        'mass'                    : 'M_{#gamma #gamma}',
...
#        inFile = ROOT.TFile.Open('rootfiles/NMinus1_photons_{}_{}{}.root'.format(sample, args.year))
        inFile = ROOT.TFile.Open('rootfiles/NMinus1_photons_{}_{}_1of1.root'.format(sample, args.year))
	if inFile == None:
#	    print('WARNING: rootfiles/NMinus1_photons_{}_{}{}.root does not exist, please create first\n'.format(sample, args.year, '_Nminus1_jets' if args.nminus1 else ''))
           print('WARNING: rootfiles/NMinus1_photons_{}_{}_1of1.root does not exist, please create first\n'.format(sample, args.year))
	   continue	
	...
	plotPhotons_filename = 'plots/{}_{}{}{}{}.png'.format(varname, args.year, '_Nminus1_photons' if args.nminus1 else '','_SoverB' if args.soverb else '', '_logy' if args.logy else '')
...
#        for bkg in ['QCDHT700','QCDHT1000','QCDHT1500','QCDHT2000','ttbar','singletop_tW','singletop_tWB']:
	for bkg in ['QCDHT700','QCDHT1000','QCDHT1500','QCDHT2000']:
...
#	     if 'signal' not in sig: continue
	...
	CompareShapes(
	    outfilename = plotPhotons_filename,
	    year = args.year,
