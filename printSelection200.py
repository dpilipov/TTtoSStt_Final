import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA200_16.root','read')
# get the histos
...
c = ROOT.TCanvas('c','c')
c.cd()
c.Print('outputSelection200.pdf[')  # this tells the canvas to open file for multi-page printing
c.Clear()
...
#       print('3.00')
    ...
    c.Print("outputSelection200.pdf")  # save it to the pdf
c.Clear()   # clear any previous draws from the canvas
#h5.SetStats(0)
#h5.SetMaximum(3.00)
hX.Draw("colz")  # draw the histo with colz
#c.Print("outputSelection.pdf")  # save it to the pdf
c.Print("outputSelection200.pdf]")  # finished, close the multipage file
