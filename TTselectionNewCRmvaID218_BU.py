...
#DP EDIT
from TTClassSublead18 import TTClassSublead18
...
#    selection = THClass('dijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.era),args.era,1,1)
    selection = TTClassSublead18('dijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.era),args.era,1,1)
...
#    args.trigEff = Correction("TriggerEff%s"%args.era,'EffLoader_2DfittedHist.cc',['out_Eff_20%s.root'%args.era,'Eff_20%s'%args.era],corrtype='weight')
    ...
    out = ROOT.TFile.Open('rootfilesMCsublead/THselection_mvaID_sublead_HT%s_%s%s_%s%s.root'%(args.HT, args.setname,
...
#        args.trigEff = Correction("TriggerEff16APV",'EffLoader_2DfittedHist.cc',['out_Eff_2016APV.root','Eff_2016APV'],corrtype='weight')
       args.trigEff = Correction("TriggerEff"+args.era,'TIMBER/Framework/include/EffLoader.h',['THtrigger2D_HT{}_16APV.root'.format(args.HT),'Pretag'], corrtype='weight')
    elif ('17' in args.era):
#        args.trigEff = Correction("TriggerEff17",'EffLoader_2DfittedHist.cc',['out_Eff_2017.root','Eff_2017'],corrtype='weight')
       args.trigEff = Correction("TriggerEff"+args.era,'TIMBER/Framework/include/EffLoader.h',['THtrigger2D_HT{}_17.root'.format(args.HT),'Pretag'], corrtype='weight')
    elif ('18' in args.era):
#        args.trigEff = Correction("TriggerEff18",'EffLoader_2DfittedHist.cc',['out_Eff_2018.root','Eff_2018'],corrtype='weight')
       args.trigEff = Correction("TriggerEff"+args.era,'TIMBER/Framework/include/EffLoader.h',['THtrigger2D_HT{}_18.root'.format(args.HT),'Pretag'], corrtype='weight')
    else:
#        args.trigEff = Correction("TriggerEff16",'EffLoader_2DfittedHist.cc',['out_Eff_2016.root','Eff_2016'],corrtype='weight')
       args.trigEff = Correction("TriggerEff"+args.era,'TIMBER/Framework/include/EffLoader.h',['THtrigger2D_HT{}_16.root'.format(args.HT),'Pretag'], corrtype='weight')
#    else:
