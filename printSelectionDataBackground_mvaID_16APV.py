import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_Data_16APV.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_ttbar_16APV.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_VJets_16APV.root','read')
f3  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_QCD_16APV.root','read')
# get the histos
...
h11.SetTitle("ttbar MC: SR pass")
h13.SetTitle("ttbar MC: CR pass")
h14.SetTitle("ttbar MC: CR fail")
...
h21.SetTitle("VJets MC: SR pass")
h23.SetTitle("VJets MC: CR pass")
h24.SetTitle("VJets MC: CR fail")
h31 = f3.Get("MtpvMs_TvsQCD_mvaID_SR_pass__nominal")
h33 = f3.Get("MtpvMs_TvsQCD_mvaID_CR_pass__nominal")
h34 = f3.Get("MtpvMs_TvsQCD_mvaID_CR_fail__nominal")
h31.SetTitle("QCD MC: SR pass")
h33.SetTitle("QCD MC: CR pass")
h34.SetTitle("QCD MC: CR fail")
...
i=0
for h in [h1, h3, h4, h11, h13, h14, h21, h23, h24, h31, h33, h34]:
...
c.Print("outputSelectionDataBackgroundM_mvaID_16APV.pdf")  # save it to the pdf
