...
#        if not self.a.isData:
        if ('16APV' in self.year):
              self.a.Define('Top1Cat','int(Dijet_TvsQCD[0]>0.74')')
              self.a.Define('Top2Cat','int(Dijet_TvsQCD[0]>0.74')')
              self.a.Define('JetSF1','getSFwp05(Top1Cat,Dijet_pt[0],"2016APV",variation)')
              self.a.Define('JetSF2','getSFwp05(Top2Cat,Dijet_pt[1],"2016APV",variation)')
              self.a.Define('PhotonEffSFpre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,0,"2016APV",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSFpre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,1,"2016APV",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSFpre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,2,"2016APV",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
        elif ('16' in self.year):
              self.a.Define('Top1Cat','int(Dijet_TvsQCD[0]>0.73')')
              self.a.Define('Top2Cat','int(Dijet_TvsQCD[0]>0.73')')
              self.a.Define('JetSF1','getSFwp05(Top1Cat,Dijet_pt[0],"2016",variation)')
              self.a.Define('JetSF2','getSFwp05(Top2Cat,Dijet_pt[1],"2016",variation)')
              self.a.Define('PhotonEffSFpre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,0,"2016",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF1pre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,1,"2016",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF2pre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,2,"2016",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
        elif ('17' in self.year):
              self.a.Define('Top1Cat','int(Dijet_TvsQCD[0]>0.8')')
              self.a.Define('Top2Cat','int(Dijet_TvsQCD[0]>0.8')')
              self.a.Define('JetSF1','getSFwp05(Top1Cat,Dijet_pt[0],"2017",variation)')
              self.a.Define('JetSF2','getSFwp05(Top2Cat,Dijet_pt[1],"2017",variation)')
              self.a.Define('PhotonEffSFpre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,0,"2017",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF1pre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,1,"2017",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF2pre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,2,"2017",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)') 
        else:
              self.a.Define('Top1Cat','int(Dijet_TvsQCD[0]>0.8')')
              self.a.Define('Top2Cat','int(Dijet_TvsQCD[0]>0.8')')
              self.a.Define('JetSF1','getSFwp05(Top1Cat,Dijet_pt[0],"2018",variation)')
              self.a.Define('JetSF2','getSFwp05(Top2Cat,Dijet_pt[1],"2018",variation)')
              self.a.Define('PhotonEffSFpre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,0,"2018",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF1pre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,1,"2018",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF2pre','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.8,2,"2018",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
#        self.a.Define('DiPhotonCat','getDiPhotonCat(Diphoton_cutBased,1.0)')
        self.a.Define('DiPhotonCat','getDiPhotonCat(Diphoton_mvaID,0.8)')
#END OF DP EDIT above four lines must be uncommented for TTselection!!!
...
# DP EDIT set the SFs to use!
        if topchoice == 1:
            self.a.Define('PhotonEffSF','JetSF1*PhotonEffSFpre')
            self.a.Define('PhotonEffSF1','JetSF1*PhotonEffSF1pre')
            self.a.Define('PhotonEffSF2','JetSF1*PhotonEffSF2pre')
        else:
            self.a.Define('PhotonEffSF','JetSF2*PhotonEffSFpre')
            self.a.Define('PhotonEffSF1','JetSF2*PhotonEffSF1pre')
            self.a.Define('PhotonEffSF2','JetSF2*PhotonEffSF2pre')
        # for trigger studies
        self.a.Define('mth_trig','mth')
        self.a.Define('leadjet','int(Dijet_pt_corr[1]>Dijet_pt_corr[0])')
        self.a.Define('pt0','(1-leadjet)*Dijet_pt_corr[0]+leadjet*Dijet_pt_corr[1]')
        self.a.Define('pt1','leadjet*Dijet_pt_corr[0]+(1-leadjet)*Dijet_pt_corr[1]')
        self.a.Define('HT','abs(pt0)+abs(pt1)')
        self.a.Define('leadA','int(Diphoton_pt[1]>Diphoton_pt[0])')
        self.a.Define('Apt0trig','(1-leadA)*Diphoton_pt[0]+leadA*Diphoton_pt[1]')
        self.a.Define('Apt1trig','leadA*Diphoton_pt[0]+(1-leadA)*Diphoton_pt[1]')
        return self.a.GetActiveNode()
