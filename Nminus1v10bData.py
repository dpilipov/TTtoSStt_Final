...
NCuts.Add('AptCutBased_cut','Diphoton_pt[0] > 0 && Diphoton_pt[1] > 0')
...
oFile = ROOT.TFile.Open('rootfiles/NMinus1_v10b_{}_{}_{}of{}.root'.format(args.setname, args.era, args.ijob, args.njobs),'RECREATE')
oFile.cd()
binning = {
#    'mtop':[25,0,300],
#    'mtphi':[25,800,2200],
