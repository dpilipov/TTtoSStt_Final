...
#            hist_tuple = (varname,varname,100,350,2350)
        if ('diApt' in varname):
            hist_tuple = (varname,varname,100,25,525)
...
#DP EDIT make sure this references the correct year!!!
    args.trigEff = Correction("TriggerEff17",'TIMBER/Framework/include/EffLoader.h',['THtrigger2D_HT0_18.root','Pretag'], corrtype='weight')
