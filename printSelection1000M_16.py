...
f1 = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1000x200_16.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1000x300_16.root','read')
# get the histos
...
c.Print("outputSelection1000M_16.pdf")  # save it to the pdf
