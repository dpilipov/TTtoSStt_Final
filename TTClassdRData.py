...
#        self.a.Define('Dijet_particleNetMD_HbbvsQCD','Dijet_particleNetMD_Xbb/(Dijet_particleNetMD_Xbb+Dijet_particleNetMD_QCD)')
#DP EDIT only add L1PreFire in case of MC, not for 2018:
        if not self.a.isData:
...
#        if not self.a.isData:
        if ('16APV' in self.year):
              self.a.Define('PhotonEffSF','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.74,0,"2016APV",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF1','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.74,1,"2016APV",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF2','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.74,2,"2016APV",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
        elif ('16' in self.year):
              self.a.Define('PhotonEffSF','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.73,0,"2016",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF1','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.73,1,"2016",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF2','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.73,2,"2016",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
