import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_Data_16.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_ttbar_16.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_VJets_16.root','read')
f3  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_QCD_16.root','read')
# get the histos
...
c.Print("outputSelectionDataBackgroundM_mvaID_16.pdf")  # save it to the pdf
