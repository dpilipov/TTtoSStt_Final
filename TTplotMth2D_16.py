...
#    else:
    fName = 'dijet_nano/StoAA1000x100_16_snapshot.txt'.format(year)
...
#    noTag = selection.a.Cut('pretrig','HLT_Mu50==1')
    ...
    # Baseline - no tagging
    hists.Add('preTagDenominator',selection.a.DataFrame.Histo2D(('preTagDenominator','',16,25,825,26,425,3025),'Smass_trig','mth_trig'))
...
#    selection.ApplyTrigs()
    hists.Add('preTagNumerator',selection.a.DataFrame.Histo2D(('preTagNumerator','',16,25,825,26,425,3025),'Smass_trig','mth_trig'))
...
#    hists.Draw("colz")
    hists.Add('mth2d',selection.a.DataFrame.Histo2D(('mth2d','',8,25,425,12,625,1825),'mthsig_trig','mth_trig'))
