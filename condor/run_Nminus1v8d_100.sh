...
echo python Nminus1v8d_100.py $*
python Nminus1v8d_100.py $*

xrdcp -f rootfiles/NMinus1_v8d100_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/rootfiles/
