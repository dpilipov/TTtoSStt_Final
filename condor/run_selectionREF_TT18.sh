...
echo python TTselectionNewCRmvaIDreflection18.py $*
python TTselectionNewCRmvaIDreflection18.py $*

xrdcp -f rootfilesREF/THselection_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/
