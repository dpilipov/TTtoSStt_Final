...
echo python TTselectionNewCRmvaIDsignalVR18.py $*
python TTselectionNewCRmvaIDsignalVR18.py $*

xrdcp -f rootfilesMCsigVR/THselection_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/
