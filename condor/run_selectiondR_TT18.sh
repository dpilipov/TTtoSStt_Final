...
echo python TTselectionNewCRmvaIDdR18.py $*
python TTselectionNewCRmvaIDdR18.py $*

xrdcp -f rootfilesdR/THselection_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/
