...
echo python TTselectionNewCRmvaID218.py $*
python TTselectionNewCRmvaID218.py $*

xrdcp -f rootfilesMCsublead/THselection_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/
