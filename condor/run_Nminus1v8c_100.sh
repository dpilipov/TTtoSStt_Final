...
echo python Nminus1v8c_100.py $*
python Nminus1v8c_100.py $*

xrdcp -f rootfiles/NMinus1_v8c100_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/rootfiles/
