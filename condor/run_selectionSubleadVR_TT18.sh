...
echo python TTselectionNewCRmvaID2vr18.py $*
python TTselectionNewCRmvaID2vr18.py $*

xrdcp -f rootfilesMCsubleadVR/THselection_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/
