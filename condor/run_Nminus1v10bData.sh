...
echo python Nminus1v10bData.py $*
python Nminus1v10bData.py $*

xrdcp -f rootfiles/NMinus1_v10b_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/rootfiles/
