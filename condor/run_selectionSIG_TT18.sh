...
echo python TTselectionNewCRmvaIDsignal18.py $*
python TTselectionNewCRmvaIDsignal18.py $*

xrdcp -f rootfilesSIG/THselection_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/
