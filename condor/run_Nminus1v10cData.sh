...
echo python Nminus1v10cData.py $*
python Nminus1v10cData.py $*

xrdcp -f rootfiles/NMinus1_v10c_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/rootfiles/
