...
echo python TTselectionNewCRmvaIDreflectionVR18.py $*
python TTselectionNewCRmvaIDreflectionVR18.py $*

xrdcp -f rootfilesMCrefVR/THselection_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/
