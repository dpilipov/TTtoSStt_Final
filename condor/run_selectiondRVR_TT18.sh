...
echo python TTselectionNewCRmvaIDdRVR18.py $*
python TTselectionNewCRmvaIDdRVR18.py $*

xrdcp -f rootfilesdRVR/THselection_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/
