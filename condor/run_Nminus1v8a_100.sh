...
echo python Nminus1v8a_100.py $*
python Nminus1v8a_100.py $*

xrdcp -f rootfiles/NMinus1_v8a100_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/rootfiles/
