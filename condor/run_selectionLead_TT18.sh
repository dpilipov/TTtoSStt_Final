...
echo python TTselectionNewCRmvaID18.py $*
python TTselectionNewCRmvaID18.py $*

xrdcp -f rootfilesMClead/THselection_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/
