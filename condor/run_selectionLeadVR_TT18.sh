...
echo python TTselectionNewCRmvaIDvr18.py $*
python TTselectionNewCRmvaIDvr18.py $*

xrdcp -f rootfilesMCleadVR/THselection_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/
