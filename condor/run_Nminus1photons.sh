...
echo python Nminus1jets.py $*
python Nminus1photons.py $*

xrdcp -f rootfiles/NMinus1_photons_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/rootfiles/
