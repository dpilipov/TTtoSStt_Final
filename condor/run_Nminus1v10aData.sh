...
echo python Nminus1v10aData.py $*
python Nminus1v10aData.py $*

xrdcp -f rootfiles/NMinus1_v10a_*.root root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/rootfiles/
