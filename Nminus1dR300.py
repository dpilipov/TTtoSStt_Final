...
#jets.Add('dR0','hardware::DeltaR(Top1_vect,Svec)')
#jets.Add('dR1','hardware::DeltaR(Top2_vect,Svec)')

# Plotting variables
plotting_vars = VarGroup('plotting_vars')
#DP EDIT
plotting_vars.Add('dRgen','hardware::DeltaR(gen_vect,Sgen_vect)')
plotting_vars.Add('dR0','hardware::DeltaR(Top1_vect,Svec)')
plotting_vars.Add('dR1','hardware::DeltaR(Top2_vect,Svec)')
plotting_vars.Add('mth1','hardware::InvariantMass({Top1_vect,Photon1_vect,Photon2_vect})')
plotting_vars.Add('mth2','hardware::InvariantMass({Top2_vect,Photon1_vect,Photon2_vect})')
...
NCuts.Add('dRgen','dRgen > 0.0')
NCuts.Add('dR0','dR0 > 0.0')
NCuts.Add('dR1','dR1 > 0.0')
NCuts.Add('mth1','mth1 > 700.0 && mth1 < 1300.0')
...
oFile = ROOT.TFile.Open('rootfiles/NMinus1_dR300_{}_{}_{}of{}.root'.format(args.setname, args.era, args.ijob, args.njobs),'RECREATE')
oFile.cd()
binning = {
    'mth1':[25,200,3025],
    'mth2':[25,200,3025],
