import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1500x100_16APV.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1500x200_16APV.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1500x300_16APV.root','read')
# get the histos
...
h1.SetTitle("1500-100: SR pass")
h3.SetTitle("1500-100: CR pass")
h4.SetTitle("1500-100: CR fail") 
...
h11.SetTitle("1500-200: SR pass")
h13.SetTitle("1500-200: CR pass")
h14.SetTitle("1500-200: CR fail")
...
h21.SetTitle("1500-300: SR pass")
h23.SetTitle("1500-300: CR pass")
h24.SetTitle("1500-300: CR fail")
...
c.Print("outputSelection1500M_mvaID_16APV.pdf")  # save it to the pdf
