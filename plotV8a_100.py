...
signals = ['StoAA','StoAA100']
#for sig in signals:
#    samples.update({sig : 'b*_{LH} %s (GeV)'%(sig[-4:])})
#for sig in signals:
#    samples.update({sig : ''})
samples.update({'StoAA100' : 'signal 1000/100'})
samples.update({'StoAA' : 'signal 1000/200'})
...
#        inFile = ROOT.TFile.Open('rootfiles/NMinus1_jets_{}_{}{}.root'.format(sample, args.year))
        inFile = ROOT.TFile.Open('rootfiles/NMinus1_v8a_{}_{}_1of1.root'.format(sample, args.year))
	if inFile == None:
#	    print('WARNING: rootfiles/NMinus1_jets_{}_{}{}.root does not exist, please create first\n'.format(sample, args.year, '_Nminus1_jets' if args.nminus1 else ''))
           print('WARNING: rootfiles/NMinus1_v8a_{}_{}_1of1.root does not exist, please create first\n'.format(sample, args.year))
	   continue	
	...
	plot_filename = 'plots/{}_{}{}{}{}.png'.format(varname, args.year, '_Nminus1_v8a' if args.nminus1 else '','_SoverB' if args.soverb else '', '_logy' if args.logy else '')
...
#        signal_hists['StoAA']=histgroups['StoAA'][varname]
#        signal_hists['StoAA100']=histgroups['StoAA100'][varname]
#        signal_hists['StoAA']='signal 1000/200'
#        signal_hists['StoAA100']='signal 1000/100'
