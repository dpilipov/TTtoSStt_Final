...
#DP EDIT SIGNAL SPECIFIC - for 'correct' (signal) vs. 'incorrect' (reflection) - here incorrect
        ...
        self.a.Define('topchoice','int(dR1<dR0)')
        self.a.Define('mth','topchoice*mth1+(1-topchoice)*mth2')
        self.a.Define('mthsig','topchoice*mth2+(1-topchoice)*mth1')
        self.a.Define('bin1','int((mth1-25.0)/100.0)')
        self.a.Define('bin2','int((mth2-25.0)/100.0)')
        self.a.Define('samebin','int(bin1==bin2)')
        # for trigger studies
        self.a.Define('mth_trig','mth')
        self.a.Define('pt0','Dijet_pt_corr[0]')
        self.a.Define('pt1','Dijet_pt_corr[1]')
