import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_HT0_Data_18.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_HT0_ttbar_18.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_HT0_VJets_18.root','read')
f3  = ROOT.TFile.Open('rootfiles/THselection_HT0_QCD_18.root','read')
# get the histos
...
c.Print("outputSelectionDataBackgroundM_18.pdf")  # save it to the pdf
