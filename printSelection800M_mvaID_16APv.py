import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA800x100_16.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA800x200_16.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA800x300_16.root','read')
# get the histos
...
c.Print("outputSelection800M_mvaID_16.pdf")  # save it to the pdf
