...
#        'photonMvaID'             : 'Photon mvaID^{#gamma 0}',
        'phMvaID1'             : 'Photon 1 mvaID^{#gamma 0}',
        'phMvaID2'             : 'Photon 2 mvaID^{#gamma 0}',
        'phMvaIDave'             : 'Photon average mvaID^{#gamma 0}',
...
#        inFile = ROOT.TFile.Open('Nminus1_v10a_Data16.root')
	if inFile == None:
...
#           print('WARNING')
#: rootfiles/NMinus1_v10a_{}_{}_1of1.root does not exist, please create first\n'.format(sample, args.year))
	   continue	
