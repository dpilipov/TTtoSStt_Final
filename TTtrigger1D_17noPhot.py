...
#    hists.Add('preTagDenominatorZoomed', selection.a.DataFrame.Histo2D(('preTagDenominatorZoomed','',8,25,425,12,625,1825),'Smass_trig','mth_trig'))
    ...
    hists.Add('preTagDenominatorApt',selection.a.DataFrame.Histo1D(('preTagDenominatorApt','',30,25,3025),'Apt0trig'))
...
#    yesTag = selection.a.Cut('posttrig','((HLT_AK8PFJet60==1) || (HLT_AK8PFJet80==1) 
#    yesTag = selection.a.Cut('posttrig','((HLT_PFHT780==1) || (HLT_PFHT890==1) || (HLT_PFHT1050==1) || (HLT_AK8PFJet450==1) || (HLT_AK8PFJet550==1) || (HLT_AK8PFJet500==1)  || (HLT_DoublePhoton70==1) || (HLT_DoublePhoton85==1) || (HLT_PFHT500_PFMET100_PFMHT100_IDTight==1))')
    yesTag = selection.a.Cut('posttrig','((HLT_PFHT780==1) || (HLT_PFHT890==1) || (HLT_PFHT1050==1) || (HLT_AK8PFJet450==1) || (HLT_AK8PFJet550==1) || (HLT_AK8PFJet500==1)  || (HLT_PFHT500_PFMET100_PFMHT100_IDTight==1))')
#(HLT_AK8PFJet420_TrimMass30==1) || (HLT_AK8PFJet320==1) || (HLT_AK8PFHT800_TrimMass50==1) || (HLT_AK8PFHT750_TrimMass50==1) || (HLT_AK8PFJet400_TrimMass30==1)
...
#    hists.Draw("colz")
    ...
    hists.Add('preTagNumeratorApt',selection.a.DataFrame.Histo1D(('preTagNumeratorApt','',30,25,3025),'Apt0trig'))
...
#    h_efficiency.Divide(hists['preTagNumeratorHT'],hists['preTagDenominatorHT'])
    ...
    out = ROOT.TFile.Open('THtrigger1D_HT{}_{}noPhot.root'.format(HT,year), 'RECREATE')
    out.cd()
    histNumHT.Write()
    histDenHT.Write()
    histNumTpt.Write()
