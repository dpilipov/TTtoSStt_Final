...
#            selection.a.Define('DiPhotonCatCRSF','updatePhotonTag(DiPhotonCat,Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,{0},{1},"2016")'.format(eff_CR_PASS, eff_CR_FAIL))
#            selection.a.Define('DiPhotonCatCRSF','updatePhotonTag(DiPhotonCat,DiphotonTag_pt,DiphotonTag_eta,DiphotonTag_cutBased,1.0,{0},{1})'.format(eff_CR_PASS, eff_CR_FAIL))
            passfailCR = selection.ApplySTagTopTagTag('CR', top_tagger, 0.8, photon_tagger, 1)
...
#            selection.a.Define('DiPhotonCatSF','updatePhotonTag(DiPhotonCat,Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,{0},{1},"2016")'.format(eff_SR_PASS, eff_SR_FAIL))
#            selection.a.Define('DiPhotonCatSF','updatePhotonTag(DiPhotonCat,DiphotonTag_pt,DiphotonTag_eta,DiphotonTag_cutBased,1.0,{0},{1})'.format(eff_SR_PASS, eff_SR_FAIL))
            passfailSR = selection.ApplySTagTopTagTag('SR', top_tagger, 0.8, photon_tagger, 1)
...
#            args.trigEff = Correction("TriggerEff17",'TIMBER/Framework/include/EffLoader_2DfittedHist.h',['out_Eff_2017B.root','Eff_2017B'],corrtype='weight')
            args.trigEff = Correction("TriggerEff17",'TIMBER/Framework/include/EffLoader_2DfittedHist.h',['out_Eff_2017.root','Eff_2017B'],corrtype='weight')
        else:
