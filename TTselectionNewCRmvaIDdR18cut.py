...
#    selection = THClass('dijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.era),args.era,1,1)
    selection = TTClassdR18('dijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.era),args.era,1,1)
...
#    print('After HT cut')
#    print(after)
    selection.a.Cut('mass_cut','mth > 850 && mth < 950 && Smass < 175 && Smass > 125')
#    selection.a.Cut('mass_cut','mth > 700')
#    print('After mass cuts')
    afterTmass = selection.a.DataFrame.Count()
#    print(afterTmass)
...
#    args.trigEff = Correction("TriggerEff%s"%args.era,'EffLoader_2DfittedHist.cc',['out_Eff_20%s.root'%args.era,'Eff_20%s'%args.era],corrtype='weight')
    ...
    print('SEL: at out')
    out = ROOT.TFile.Open('rootfilesdR/THselection_mvaID_dR_HT%s_%s%s_%s%s.root'%(args.HT, args.setname,
