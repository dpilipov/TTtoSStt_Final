...
#    else:
    fName = 'dijet_nano/SingleMuonData_17B_snapshot.txt'
#    fName = 'dijet_nano/ttgg_17_snapshot.txt'
...
#    yesTag = selection.a.Cut('posttrig','((HLT_PFHT500_PFMET100_PFMHT100_IDTight==1) || (HLT_AK8PFJet330_TrimMass30_PFAK8BoostedDoubleB_np4==1) || (HLT_AK8PFJet60==1) || (HLT_AK8PFJet80==1) || (HLT_PFHT1050==1) || (HLT_AK8PFHT800_TrimMass50==1) || (HLT_AK8PFJet500==1) || (HLT_AK8PFJet400_TrimMass30==1) || (HLT_AK8PFHT750_TrimMass50==1) || (HLT_DoublePhoton85==1))')
#    yesTag = selection.a.Cut('posttrig','(HLT_PFHT1050==1) || (HLT_AK8PFHT800_TrimMass50==1) || (HLT_AK8PFJet420_TrimMass30==1) || (HLT_AK8PFJet320==1) || (HLT_AK8PFJet450==1) || (HLT_AK8PFJet550==1) || (HLT_AK8PFJet500==1) || (HLT_AK8PFJet400_TrimMass30==1) || (HLT_AK8PFHT750_TrimMass50==1) || (HLT_PFHT500_PFMET100_PFMHT100_IDTight==1) || (HLT_DoublePhoton70==1) || (HLT_DoublePhoton85==1)')
#    hists.Add('preTagNumerator',selection.a.DataFrame.Histo2D(('preTagNumerator','',16,25,825,24,625,3025),'Smass_trig','mth_trig'))
#    yesTag = selection.a.Cut('posttrig','(('HLT_AK8PFJet60==1) || (HLT_AK8PFJet80==1) || (HLT_PFHT1050==1) || (HLT_AK8PFJet500==1) || (HLT_AK8PFHT750_TrimMass50==1) || (HLT_AK8PFHT800_TrimMass50==1) || (HLT_AK8PFJet400_TrimMass30==1) || (HLT_Diphoton30EB_18EB_R9Id_OR_IsoCaloId_AND_HE_R9Id_DoublePixelVeto_Mass55==1))')
#    yesTag2 = selection.a.Cut('posttrig2','((HLT_Diphoton30PV_18PV_R9Id_AND_IsoCaloId_AND_HE_R9Id_DoublePixelVeto_Mass55==1) || (HLT_Diphoton30_18_R9Id_OR_IsoCaloId_AND_HE_R9Id_DoublePixelSeedMatch_Mass70==1))')
#    yesTag1 = selection.a.Cut('posttrig1','((HLT_Diphoton30_18_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass90==1) || (HLT_Diphoton30_18_Solid_R9Id_AND_IsoCaloId_AND_HE_R9Id_Mass55==1) || (HLT_DoublePhoton60==1) || (HLT_DoublePhoton85==1))')
#    yesTag = selection.a.Cut('posttrig','((HLT_AK8PFJet60==1) || (HLT_AK8PFJet80==1) || (HLT_PFHT780==1) || (HLT_PFHT890==1) || (HLT_PFHT1050==1) || (HLT_AK8PFJet450==1) || (HLT_AK8PFJet550==1) || (HLT_AK8PFJet500==1)  || (HLT_DoublePhoton70==1) || (HLT_DoublePhoton85==1) || (HLT_PFHT500_PFMET100_PFMHT100_IDTight==1))')
#    yesTag0 = selection.a.Cut('posttrig','((HLT_PFHT1050==1) || (HLT_AK8PFJet500==1) || (HLT_AK8PFHT750_TrimMass50==1) || (HLT_AK8PFHT800_TrimMass50==1) || (HLT_AK8PFJet400_TrimMass30==1))')
# This one works...
...
#    yesTag2 = selection.a.Cut('posttrig','((HLT_AK8PFJet420_TrimMass30==1) || (HLT_AK8PFJet320==1) || (HLT_AK8PFHT800_TrimMass50==1) || (HLT_AK8PFHT750_TrimMass50==1) || (HLT_AK8PFJet400_TrimMass30==1))')
...
#    h_efficiency.Divide(hists['preTagNumeratorHT'],hists['preTagDenominatorHT'])
    ...
    out = ROOT.TFile.Open('THtrigger1D_HT{}_{}B.root'.format(HT,year), 'RECREATE')
    out.cd()
    histNumHT.Write()
    histDenHT.Write()
    histNumTpt.Write()
