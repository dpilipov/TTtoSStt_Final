import ROOT
f = ROOT.TFile.Open('rootfilesMClead/THselection_mvaID_HT850_StoAA1000x100_17.root','read')
f1 = ROOT.TFile.Open('rootfilesMClead/THselectionCorr_mvaID_HT850_StoAA1000x100_17.root','read')
f2 = ROOT.TFile.Open('rootfilesMClead/THselectionIncorr_mvaID_HT850_StoAA1000x100_17.root','read')
# get the histos
...
h1.SetTitle("Leading Selection 1000-100: SR pass")
#h3.SetTitle("1000-100: CR pass")
h4.SetTitle("Leading Selection 1000-100: CR fail") 
...
h11.SetTitle("Leading Selection - Correct 1000-100: SR pass")
#h13.SetTitle("1000-200: CR pass")
h14.SetTitle("Leading Selection - Correct 1000-100: CR fail")
...
h21.SetTitle("Leading Selection - Incorrect 1000-100: SR pass")
#h23.SetTitle("Leading Selection - Incorrect 1000-300: CR pass")
h24.SetTitle("Leading Selection - Incorrect 1000-100: CR fail")
...
c.Print("outputSelection1000x100LeadingCORR_mvaID_17.pdf")  # save it to the pdf
