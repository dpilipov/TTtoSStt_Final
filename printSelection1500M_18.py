import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1500x100_18.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1500x200_18.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1500x300_18.root','read')
# get the histos
...
c.Print("outputSelection1500M_18.pdf")  # save it to the pdf
