import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1300x100_16.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1300x200_16.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1300x300_16.root','read')
# get the histos
...
c.Print("outputSelection1300M_16.pdf")  # save it to the pdf
