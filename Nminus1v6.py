...
selection.a.Cut('photonMvaID','Diphoton_mvaID[0] > -1.0 && Diphoton_mvaID[1] > -1.0')
...
NCuts.Add('photonMvaID_cut','Diphoton_mvaID[0] > -0.985 && Diphoton_mvaID[1] > -0.985')
...
oFile = ROOT.TFile.Open('rootfiles/NMinus1_v6_{}_{}_{}of{}.root'.format(args.setname, args.era, args.ijob, args.njobs),'RECREATE')
oFile.cd()
binning = {
    'mtop':[25,0,300],
#    'mtphi':[25,800,2200],
