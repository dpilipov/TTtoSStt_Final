...
#        inFile = ROOT.TFile.Open('rootfiles/NMinus1_jets_{}_{}{}.root'.format(sample, args.year))
        inFile = ROOT.TFile.Open('rootfiles/NMinus1_v5_{}_{}_1of1.root'.format(sample, args.year))
	if inFile == None:
#	    print('WARNING: rootfiles/NMinus1_jets_{}_{}{}.root does not exist, please create first\n'.format(sample, args.year, '_Nminus1_jets' if args.nminus1 else ''))
           print('WARNING: rootfiles/NMinus1_v5_{}_{}_1of1.root does not exist, please create first\n'.format(sample, args.year))
	   continue	
	...
	plot_filename = 'plots/{}_{}{}{}{}.png'.format(varname, args.year, '_Nminus1_v5' if args.nminus1 else '','_SoverB' if args.soverb else '', '_logy' if args.logy else '')
