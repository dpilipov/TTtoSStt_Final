import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1000x100_18.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1000x200_18.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1000x300_18.root','read')
# get the histos
...
c.Print("outputSelection1000M_18.pdf")  # save it to the pdf
