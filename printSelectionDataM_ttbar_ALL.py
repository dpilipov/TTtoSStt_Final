...
h11.SetTitle("Data: VR2-SR pass")
h13.SetTitle("Data: VR2-CR pass")
h14.SetTitle("Data: VR2-CR fail")
...
c.Print("outputSelectionData_mvaID_HT850_ALL.pdf")  # save it to the pdf
