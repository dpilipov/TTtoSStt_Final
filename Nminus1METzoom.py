...
selection.a.Cut('METpt_cut0','MET_pt>350')
...
selection.a.Cut('HT','Dijet_pt[0] + Dijet_pt[1] > 850')
...
NCuts.Add('TPmassMvaID_cut','TPmassMvaID > 625')
NCuts.Add('SmassMvaID_cut','SmassMvaID>75')
NCuts.Add('METpt_cut','METpt>400')
...
oFile = ROOT.TFile.Open('rootfiles/NMinus1_MET_{}_{}_{}of{}.root'.format(args.setname, args.era, args.ijob, args.njobs),'RECREATE')
oFile.cd()
binning = {
#    'mtop':[25,0,300],
#    'mtphi':[25,800,2200],
