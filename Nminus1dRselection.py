...
#    if ('mtop' not in nkey) and ('pt0' not in nkey) and ('pt1' not in nkey) and ('deltaEta' not in nkey) and ('topTag0' not in nkey) and ('topTag1' not in nkey):
    if ('icorrect'  not in nkey) and  ('iincorrect'  not in nkey) and ('mth'  not in nkey) and ('dRselection1'  not in nkey) and ('dRgen'  not in nkey) and ('dR0'  not in nkey) and ('dR1'  not in nkey) and ('dRsignal' not in nkey) and ('dRreflection' not in nkey) and ('dtopR' not in nkey) and ('dRselsig' not in nkey) and ('mthsel1' not in nkey) and ('mthsig' not in nkey) and ('mthref' not in nkey) and ('mth1x' not in nkey) and ('mth2x' not in nkey) and ('dRselection2' not in nkey) and ('deltaR' not in nkey) and ('mthsel2' not in nkey) and ('mtop' not in nkey) and ('pt' not in nkey) and ('deltaEta' not in nkey) and ('topTag' not in nkey):
	continue
    print('2')	
