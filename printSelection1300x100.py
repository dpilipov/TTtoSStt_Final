...
c = ROOT.TCanvas('c','c')
c.cd()
c.Print('outputSelection1000x100_16AllRegions.pdf[')  # this tells the canvas to open file for multi-page printing
c.Clear()
...
#       print('3.00')
    ...
    c.Print("outputSelection1000x100_16AllRegions.pdf")  # save it to the pdf
#c.Clear()   # clear any previous draws from the canvas
#h5.SetStats(0)
#h5.SetMaximum(3.00)
