...
#DP EDIT
from TTClassREF18 import TTClassREF18
...
#    selection = THClass('dijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.era),args.era,1,1)
    selection = TTClassREF18('dijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.era),args.era,1,1)
...
#    args.trigEff = Correction("TriggerEff%s"%args.era,'EffLoader_2DfittedHist.cc',['out_Eff_20%s.root'%args.era,'Eff_20%s'%args.era],corrtype='weight')
    ...
    print('SEL: at out')
    out = ROOT.TFile.Open('rootfilesREF/THselection_mvaID_ref_HT%s_%s%s_%s%s.root'%(args.HT, args.setname,
