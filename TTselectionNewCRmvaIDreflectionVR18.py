...
#DP EDIT
from TTClassREFVR18 import TTClassREFVR18
...
#    selection = THClass('dijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.era),args.era,1,1)
    selection = TTClassREFVR18('dijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.era),args.era,1,1)
...
#    args.trigEff = Correction("TriggerEff%s"%args.era,'EffLoader_2DfittedHist.cc',['out_Eff_20%s.root'%args.era,'Eff_20%s'%args.era],corrtype='weight')
    ...
    print('SEL: at out')
    out = ROOT.TFile.Open('rootfilesMCrefVR/THselection_mvaID_VR_HT%s_%sref%s_%s%s.root'%(args.HT, args.setname,
