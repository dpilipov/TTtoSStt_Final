...
from TTClassdR import TTClassdR
...
selection = TTClassdR('raw_nano/%s_%s.txt'%(args.setname,args.era),args.era,args.ijob,args.njobs)
...
#NCuts.Add('phMvaIDave_cut','photonMvaIDave>0.0')
