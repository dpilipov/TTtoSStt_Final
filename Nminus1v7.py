...
NCuts.Add('photonMvaID_cut','Diphoton_mvaID[0] > -0.995 && Diphoton_mvaID[1] > -0.995')
...
oFile = ROOT.TFile.Open('rootfiles/NMinus1_v7_{}_{}_{}of{}.root'.format(args.setname, args.era, args.ijob, args.njobs),'RECREATE')
oFile.cd()
binning = {
    'mtop':[25,0,300],
#    'mtphi':[25,800,2200],
