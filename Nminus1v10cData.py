...
NCuts.Add('photonMvaID_cut','Diphoton2_mvaID[0] > -0.6 && Diphoton2_mvaID[1] > -0.6')
...
oFile = ROOT.TFile.Open('rootfiles/NMinus1_v10c_{}_{}_{}of{}.root'.format(args.setname, args.era, args.ijob, args.njobs),'RECREATE')
oFile.cd()
binning = {
#    'mtop':[25,0,300],
#    'mtphi':[25,800,2200],
