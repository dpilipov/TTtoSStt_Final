...
#        self.a.Define('DiphotonIds','PickDiphotons(Photon_pt,Photon_eta,Photon_phi,Photon_mass,Photon_cutBased)')
        self.a.Define('DiphotonIds','PickDiphotons2(Photon_pt,Photon_eta,Photon_phi,Photon_mass,Photon_mvaID)')
...
#        self.a.Define('DiphotonIdxs','PickDiphotons(Photon_pt, Photon_eta, Photon_phi, Photon_mass,Photon_cutBased)')
        self.a.Define('DiphotonIdxs','PickDiphotons2(Photon_pt, Photon_eta, Photon_phi, Photon_mass,Photon_mvaID)')
...
#DP EDIT
	...
	'''
	    ...
	    'FatJet_pt', # keep this so that we can calculate the HT 
            ...
            'Diphoton_mvaID','Diphoton_cutBased','Diphoton_r9',
            'Diphoton_isScEtaEB','Diphoton_isScEtaEE',
...
#DP: END OF EDIT
    ...
    def OpenForSelection(self,variation):
        if not self.a.isData:
#          genWXCorr    = Correction('genW','TIMBER/Framework/TopPhi_modules/BranchCorrection.cc',corrtype='corr',mainFunc='evalCorrection') # workaround so we can have multiple BCs
#          self.a.AddCorrection(genWXCorr, evalArgs={'val':'genWeight'})
#          L1PreFire = genWXCorr.Clone('L1PreFire',newMainFunc='evalWeight',newType='weight')
...
#          SFcorr = genWXCorr.Clone('SFcorr',newMainFunc='evalWeight',newType='weight')
...
#DP EDIT TURN THIS OFF FOR TTdistributions
