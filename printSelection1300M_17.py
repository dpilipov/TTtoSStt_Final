import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1300x100_17.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1300x200_17.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1300x300_17.root','read')
# get the histos
...
c.Print("outputSelection1300M_17.pdf")  # save it to the pdf
