...
for f in files.split('\n'):
    ...
    print(setname)
    print(year)
    if ("JetsHT400" in setname) or ("StoAA1000x250_16APV" in setname) or ("StoAA1000x250_16" in setname) or ("StoAA1100x100_18" in setname) or ("StoAA1100x250_16APV" in setname) or ("StoAA1100x250_16" in setname) or ("StoAA1100x300_16APV" in setname) or ("StoAA1100x350_17" in setname) or ("StoAA1200x150_18" in setname) or ("StoAA1200x300_17" in setname) or ("StoAA1300x150_18" in setname) or ("StoAA1300x250_17" in setname) or ("StoAA1300x250_18" in setname) or ("StoAA1300x350_17" in setname) or ("StoAA1400x100_17" in setname) or ("StoAA1400x300_17" in setname) or ("StoAA1400x350_17" in setname) or ("StoAA1500x150_18" in setname) or ("StoAA1500x350_17" in setname) or ("StoAA800x150_18" in setname) or ("StoAA800x250_18" in setname) or ("StoAA800x350_16APV" in setname) or ("StoAA900x200_17" in setname) or ("StoAA900x350_17" in setname): continue
