...
NCuts.Add('mth1','mth1 > 800.0 && mth1 < 1200.0')
...
oFile = ROOT.TFile.Open('rootfiles/NMinus1_dR200_{}_{}_{}of{}.root'.format(args.setname, args.era, args.ijob, args.njobs),'RECREATE')
oFile.cd()
binning = {
    'mth1':[25,200,3025],
    'mth2':[25,200,3025],
