...
NCuts.Add('deltaR_cut','deltaR < 2.4')
...
NCuts.Add('AdPhi_cut','abs(Diphoton_phi[0]-Diphoton_phi[1])<1.6')
...
oFile = ROOT.TFile.Open('rootfiles/NMinus1_v4_{}_{}_{}of{}.root'.format(args.setname, args.era, args.ijob, args.njobs),'RECREATE')
oFile.cd()
binning = {
    'mtop':[25,0,300],
#    'mtphi':[25,800,2200],
