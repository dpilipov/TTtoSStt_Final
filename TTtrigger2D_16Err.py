...
#    hists.Add('preTagDenominator',selection.a.DataFrame.Histo2D(('preTagDenominator','',16,25,825,24,625,3025),'Smass_trig','mth_trig'))
    ...
    hists.Add('preTagDenominatorTpt',selection.a.DataFrame.Histo1D(('preTagDenominatorTpt','',0,25,3025),'pt0'))
    hists.Add('preTagDenominatorApt',selection.a.DataFrame.Histo1D(('preTagDenominatorApt','',0,25,3025),'Apt0'))
...
#    hists.Add('preTagNumerator',selection.a.DataFrame.Histo2D(('preTagNumerator','',16,25,825,24,625,3025),'Smass_trig','mth_trig'))
    ...
    hists.Add('preTagNumeratorTpt',selection.a.DataFrame.Histo1D(('preTagNumeratorTpt','',0,25,3025),'pt0'))
    hists.Add('preTagNumeratorApt',selection.a.DataFrame.Histo1D(('preTagNumeratorApt','',0,25,3025),'Apt0'))
#    hists.Draw("colz")
    ...
    out = ROOT.TFile.Open('THtrigger2Derr_HT{}_{}.root'.format(HT,year), 'RECREATE')
    out.cd()
