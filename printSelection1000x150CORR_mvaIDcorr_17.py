import ROOT
f = ROOT.TFile.Open('rootfiles/THselectionALL_mvaID_HT850_StoAA1000x150_17.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselectionCorr_mvaID_HT850_StoAA1000x150_17.root','read')
f2 = ROOT.TFile.Open('rootfiles/THselectionIncorr_mvaID_HT850_StoAA1000x150_17.root','read')
# get the histos
...
h1.SetTitle("Combination Selection 1000-150: SR pass")
#h3.SetTitle("1000-150: CR pass")
h4.SetTitle("Combination Selection 1000-150: CR fail") 
...
h11.SetTitle("Combination Selection - Correct 1000-150: SR pass")
#h13.SetTitle("1000-200: CR pass")
h14.SetTitle("Combination Selection - Correct 1000-150: CR fail")
...
h21.SetTitle("Combination Selection - Incorrect 1000-150: SR pass")
#h23.SetTitle("Combination Selection - Incorrect 1000-300: CR pass")
h24.SetTitle("Combination Selection - Incorrect 1000-150: CR fail")
...
c.Print("outputSelection1000x150CORR_mvaID_17.pdf")  # save it to the pdf
