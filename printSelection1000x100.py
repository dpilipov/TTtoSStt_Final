import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1000x100_16.root','read')
# get the histos
...
h1.SetTitle("Region: 2 true tops, 2 true photons")
h2.SetTitle("Region: 2 true tops, 1 true photon")
h3.SetTitle("Region: 1 true top, 2 true photons")
h4.SetTitle("Region: 1 true top, 1 true photon")
h5.SetTitle("Region: 2 true tops, 0 true photons")
h6.SetTitle("Region: 1 true top, 0 true photons")
...
c.Print("outputSelection1000x100_16AllRegions.pdf")  # finished, close the multipage file
