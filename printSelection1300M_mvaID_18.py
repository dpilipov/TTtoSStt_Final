import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1300x100_18.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1300x200_18.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1300x300_18.root','read')
# get the histos
...
c.Print("outputSelection1300M_mvaID_18.pdf")  # save it to the pdf
