import ROOT
f = ROOT.TFile.Open('rootfilesdR/THselection_mvaID_dR_HT0_StoAA1000x100_18.root','read')
f1 = ROOT.TFile.Open('rootfilesdR/THselection_mvaID_dR_HT700_StoAA1000x100_18.root','read')
f2  = ROOT.TFile.Open('rootfilesdR/THselection_mvaID_dR_HT900_StoAA1000x100_18.root','read')
# get the histos
...
h1.SetTitle("1000-100 HT0: SR")
#h3.SetTitle("1000-100 HT0: CR pass")
h4.SetTitle("1000-100 HT0: CR") 
...
h11.SetTitle("1000-100 HT700: SR")
#h13.SetTitle("1000-100 HT700: CR pass")
h14.SetTitle("1000-100 HT700: CR")
...
h21.SetTitle("1000-100 HT900: SR")
#h23.SetTitle("1000-100 HT900: CR pass")
h24.SetTitle("1000-100 HT900: CR")
...
c.Print("outputSelection1000x100_mvaID_dR_18_HTcomp.pdf")  # save it to the pdf
