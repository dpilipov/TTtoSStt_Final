...
#    hists.Add('preTagDenominatorApt',selection.a.DataFrame.Histo1D(('preTagDenominatorApt','',0,25,3025),'Diphoton2_pt[0]'))
...
#    hists.Add('preTagNumeratorApt',selection.a.DataFrame.Histo1D(('preTagNumeratorApt','',0,25,3025),'Diphoton2_pt[0]'))
#    hists.Draw("colz")
...
#DP EDIT -- only left 16 below...
    files = {
        '16': ROOT.TFile.Open('THtrigger2DT_HT{}_16.root'.format(args.HT))
