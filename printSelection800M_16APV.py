import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA800x100_16APV.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA800x200_16APV.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA800x300_16APV.root','read')
# get the histos
...
c.Print("outputSelection800M_16APV.pdf")  # save it to the pdf
