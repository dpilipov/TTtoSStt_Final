...
NCuts.Add('dR0','dR0 > 0.6')
NCuts.Add('dR1','dR1 > 0.6')
...
oFile = ROOT.TFile.Open('rootfiles/NMinus1_dRsel0p6cut_{}_{}_{}of{}.root'.format(args.setname, args.era, args.ijob, args.njobs),'RECREATE')
oFile.cd()
binning = {
#    'mth1':[25,200,3025],
#    'mth2':[25,200,3025],
