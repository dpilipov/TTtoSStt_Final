import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1000x100_16APV.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1000x200_16APV.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1000x300_16APV.root','read')
# get the histos
...
c.Print("outputSelection1000M_mvaID_16APV.pdf")  # save it to the pdf
