...
#      if (year==16):
    ...
    if selection:
        ...
        for year, varDict in years.items():
#          if (year==16):
	    if not os.path.exists('root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/THselection_mvaID_lead_HT{}_{}_{}.root'.format(HT, setName, year)):
	        pass
#	    f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT{}_{}_{}.root'.format(HT, setName, year))
            f = ROOT.TFile.Open('root://cmseos.fnal.gov//store/user/dpilipov/topHBoostedAllHad/selection/THselection_mvaID_lead_HT{}_{}_{}.root'.format(HT, setName, year))
            print(f)
	    h = f.Get('cutflow')
