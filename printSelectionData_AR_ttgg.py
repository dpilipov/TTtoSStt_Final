import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT850_ttbar-gg.root','read')
# get the histos
...
h1.SetTitle("ttbar-gg: 2t2a")
h3.SetTitle("ttbar-gg: 2t1a")
h4.SetTitle("ttbar-gg: 2t0a") 
...
h11.SetTitle("ttbar-gg: 1t2a")
h13.SetTitle("ttbar-gg: 1t1a")
h14.SetTitle("ttbar-gg: 1t0a")
...
c.Print("outputSelectionttgg_AR.pdf")  # save it to the pdf
