import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_Data.root','read')
# get the histos
...
h11.SetTitle("Data: 1t2a")
h13.SetTitle("Data: 1t1a")
h14.SetTitle("Data: 1t0a")
...
c.Print("outputSelectionDataM_mvaID_AR.pdf")  # save it to the pdf
