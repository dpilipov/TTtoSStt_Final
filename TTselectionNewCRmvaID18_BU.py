...
#DP EDIT
from TTClassLead18 import TTClassLead18
...
#    selection = THClass('dijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.era),args.era,1,1)
    selection = TTClassLead18('dijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.era),args.era,1,1)
...
#                e0CR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[0]', wp=0.74, idx=0, tag='cr1')
#                e1CR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[1]', wp=0.74, idx=1, tag='cr2')
#                selection.ApplyTopPick_CR(TopTagger='Dijet_'+top_tagger, pt='Dijet_pt_corr', topinjet='Dijet_topinjet', TopScoreCut=0.74, eff0=e0CR, eff1=e1CR, year=args.era, TopVariation=TopVar)
                eff_CR_PASS, eff_CR_FAIL, eff_CR_FAILFAIL = getSaaEfficienciesTag(selection.a, 'CR', top_tagger, 0.74, photon_tagger, 0.8)
                ...
                passfailCR_SF = selection.ApplySTagTopTagSF('CR', top_tagger, 0.74, photon_tagger, 0.8)
            elif ('17' in args.era):
...
#                selection.ApplyTopPick_CR(TopTagger='Dijet_'+top_tagger, pt='Dijet_pt_corr', topinjet='Dijet_topinjet', TopScoreCut=0.8, eff0=e0CR, eff1=e1CR, year=args.era, TopVariation=TopVar)
                eff_CR_PASS, eff_CR_FAIL, eff_CR_FAILFAIL = getSaaEfficienciesTag(selection.a, 'CR', top_tagger, 0.8, photon_tagger, 0.8)
                ...
                passfailCR_SF = selection.ApplySTagTopTagSF('CR', top_tagger, 0.8, photon_tagger, 0.8)
            elif ('18' in args.era):
#                e0CR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[0]', wp=0.8, idx=0, tag='cr1')
#                e1CR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[1]', wp=0.8, idx=1, tag='cr2')
#                selection.ApplyTopPick_CR(TopTagger='Dijet_'+top_tagger, pt='Dijet_pt_corr', topinjet='Dijet_topinjet', TopScoreCut=0.8, eff0=e0CR, eff1=e1CR, year=args.era, TopVariation=TopVar)
...
#                e0CR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[0]', wp=0.73, idx=0, tag='cr1')
#                e1CR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[1]', wp=0.73, idx=1, tag='cr2')
#                selection.ApplyTopPick_CR(TopTagger='Dijet_'+top_tagger, pt='Dijet_pt_corr', topinjet='Dijet_topinjet', TopScoreCut=0.73, eff0=e0CR, eff1=e1CR, year=args.era, TopVariation=TopVar)
                eff_CR_PASS, eff_CR_FAIL, eff_CR_FAILFAIL = getSaaEfficienciesTag(selection.a, 'CR', top_tagger, 0.73, photon_tagger, 0.8)
                ...
                passfailCR_SF = selection.ApplySTagTopTagSF('CR', top_tagger, 0.73, photon_tagger, 0.8)

#            selection.a.Define('inTop1CR','topInJet(Dijet_pt_corr[0],Dijet_phi[0], Dijet_eta[0], Dijet_msoftdrop_corrT[0],nGenPart, GenPart_pt,GenPart_phi,GenPart_eta, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother)')
#            selection.a.Define('inTop2CR','topInJet(Dijet_pt_corr[1], Dijet_phi[1], Dijet_eta[1], Dijet_msoftdrop_corrT[1], nGenPart, GenPart_pt, GenPart_phi, GenPart_eta, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother)')
...
#            eA0CR = getPhotonEfficiencies(analyzer=selection.a, tagger='Diphoton_'+photon_tagger+'[0]', wp=0.8, idx=0, tag='cr1')
#            eA1CR = getPhotonEfficiencies(analyzer=selection.a, tagger='Diphoton_'+photon_tagger+'[1]', wp=0.8, idx=1, tag='cr2')
#            selection.a.Define('DiPhotonCatCRSF','updatePhotonTag(1,DiPhotonCat,DiphotoniTag_pt,DiphotonTag_eta,DiphotonTag_mvaID,0.8,{0},{1})'.format(eff_CR_PASS, eff_CR_FAIL))
...
#DP EDIT
            if ('16APV' in args.era):
#                e0SR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[0]', wp=0.74, idx=0, tag='sr1')
#                e1SR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[1]', wp=0.74, idx=1, tag='sr2')
#                selection.ApplyTopPick_SR(TopTagger='Dijet_'+top_tagger, pt='Dijet_pt_corr', topinjet='Dijet_topinjet', TopScoreCut=0.74, eff0=e0SR, eff1=e1SR, year=args.era, TopVariation=TopVar)
                eff_SR_PASS, eff_SR_FAIL, eff_SR_FAILFAIL = getSaaEfficienciesTag(selection.a, 'SR', top_tagger, 0.74, photon_tagger, 0.8)
                selection.a.Define('DiPhotonCatSF','updatePhotonTag(1,DiPhotonCat,Diphoton_pt,Diphoton_eta,Diphoton_mvaID,0.74,{0},{1},"2016APV",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)'.format(eff_SR_PASS, eff_SR_FAIL))
                passfailSR_SF = selection.ApplySTagTopTagSF('SR', top_tagger, 0.74, photon_tagger, 0.8)
            elif ('17' in args.era):
...
#                selection.ApplyTopPick_SR(TopTagger='Dijet_'+top_tagger, pt='Dijet_pt_corr', topinjet='Dijet_topinjet', TopScoreCut=0.8, eff0=e0SR, eff1=e1SR, year=args.era, TopVariation=TopVar)
                eff_SR_PASS, eff_SR_FAIL, eff_SR_FAILFAIL = getSaaEfficienciesTag(selection.a, 'SR', top_tagger, 0.8, photon_tagger, 0.8)
                ...
                passfailSR_SF = selection.ApplySTagTopTagSF('SR', top_tagger, 0.8, photon_tagger, 0.8)
            elif ('18' in args.era):
#                e0SR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[0]', wp=0.8, idx=0, tag='sr1')
#                e1SR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[1]', wp=0.8, idx=1, tag='sr2')
#                selection.ApplyTopPick_SR(TopTagger='Dijet_'+top_tagger, pt='Dijet_pt_corr', topinjet='Dijet_topinjet', TopScoreCut=0.8, eff0=e0SR, eff1=e1SR, year=args.era, TopVariation=TopVar)
...
#                e0SR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[0]', wp=0.73, idx=0, tag='sr1')
#                e1SR = getTopEfficiencies(analyzer=selection.a, tagger='Dijet_'+top_tagger+'[1]', wp=0.73, idx=1, tag='sr2')
#                selection.ApplyTopPick_SR(TopTagger='Dijet_'+top_tagger, pt='Dijet_pt_corr', topinjet='Dijet_topinjet', TopScoreCut=0.73, eff0=e0SR, eff1=e1SR, year=args.era, TopVariation=TopVar)
                eff_SR_PASS, eff_SR_FAIL, eff_SR_FAILFAIL = getSaaEfficienciesTag(selection.a, 'SR', top_tagger, 0.73, photon_tagger, 0.8)
                ...
                passfailSR_SF = selection.ApplySTagTopTagSF('SR', top_tagger, 0.73, photon_tagger, 0.8)

#            selection.a.Define('inTop1SR','topInJet(Dijet_pt_corr[0],Dijet_phi[0], Dijet_eta[0], Dijet_msoftdrop_corrT[0],nGenPart, GenPart_pt,GenPart_phi,GenPart_eta, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother)')
#            selection.a.Define('inTop2SR','topInJet(Dijet_pt_corr[1], Dijet_phi[1], Dijet_eta[1], Dijet_msoftdrop_corrT[1], nGenPart, GenPart_pt, GenPart_phi, GenPart_eta, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother)')
...
#            selection.a.Define('DiPhotonCatSF','updatePhotonTag(1,DiPhotonCat,DiphotonTag_pt,DiphotonTag_eta,DiphotonTag_mvaID,0.8,{0},{1})'.format(eff_SR_PASS, eff_SR_FAIL))
...
#        print('calculating trigger now, 2016...')
#    else
#    args.trigEff = Correction("TriggerEff%s"%args.era,'EffLoader_2DfittedHist.cc',['out_Eff_20%s.root'%args.era,'Eff_20%s'%args.era],corrtype='weight')
