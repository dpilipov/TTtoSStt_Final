import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1500x100_16APV.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1500x200_16APV.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_HT0_StoAA1500x300_16APV.root','read')
# get the histos
...
c.Print("outputSelection1500M_16APV.pdf")  # save it to the pdf
