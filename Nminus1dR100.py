...
NCuts.Add('mth1','mth1 > 900.0 && mth1 < 1100.0')
...
oFile = ROOT.TFile.Open('rootfiles/NMinus1_dR100_{}_{}_{}of{}.root'.format(args.setname, args.era, args.ijob, args.njobs),'RECREATE')
oFile.cd()
binning = {
    'mth1':[25,200,3025],
    'mth2':[25,200,3025],
