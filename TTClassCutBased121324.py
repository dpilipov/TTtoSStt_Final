...
#DP EDIT ADD 2 photon Preselection - change it back to no requirement
        ...
        self.a.Cut('pT', 'FatJet_pt[DijetIdxs[0]] > {0} && FatJet_pt[DijetIdxs[1]] > {0}'.format(self.cuts['pt']))
        ...
        self.a.Cut('prePselected','DiphotonIdxs[0]> -1 && DiphotonIdxs[1] > -1') #Cut the data according to 2 photons
        self.NAID = self.getNweighted()
        self.AddCutflowColumn(self.NAID, "NAID")
	...
	self.AddCutflowColumn(self.NDELTAETA,'NDELTAETA')
        ...
        self.NPHOTONNOTE = self.getNweighted()
        self.AddCutflowColumn(self.NPHOTONNOTE,'NPHOTONNOTE')
        ...
        self.NPHOTONINB = self.getNweighted()
        self.AddCutflowColumn(self.NPHOTONINB,'NPHOTONINB')
        return self.a.GetActiveNode()
...
#                self.a.AddCorrection(Correction('TopPtSF',corrtype='weight'))               
                print('at Corr1')
#NOW ORIGINAL...
...
#DP EDIT
    def analysis1(self):
        ...
        self.a.Define('HTjets','Dijet_pt[0]+Dijet_pt[1]')
        self.a.Define('HTphotons','Diphoton_pt[0]+Diphoton_pt[1]')
	...
	'''
	    ...
	    'FatJet_pt', # keep this so that we can calculate the HT 
            ...
            'Dijet_particleNet_TvsQCD', 'Dijet_rawFactor',
            ...
            'HLT_Diphoton*','HLT_DoublePhoton*','HLT_Photon*','HLT_Photon*','HLT_MET*',
...
#            columns.extend(['TopSF1__nom','TopSF1__up','TopSF1__down','TopSF2__nom','TopSF2__up','TopSF2__down'])
...
#        if not self.a.isData:
        if ('16APV' in self.year):
              ...
              self.a.Define('PhotonEffSF','getPhotonSF(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,0,"2016APV",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF1','getPhotonSF(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,1,"2016APV",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF2','getPhotonSF(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,2,"2016APV",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              ...
              self.a.Define('PhotonEffSF','getPhotonSF(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,0,"2016",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF1','getPhotonSF(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,1,"2016",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF2','getPhotonSF(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,2,"2016",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              ...
              self.a.Define('PhotonEffSF','getPhotonSF(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,0,"2017",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF1','getPhotonSF(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,1,"2017",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF2','getPhotonSF(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,2,"2017",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)') 
        else:
              self.a.Define('Top1Cat','int(Dijet_particleNet_TvsQCD[0]>0.8)')
              self.a.Define('Top2Cat','int(Dijet_particleNet_TvsQCD[0]>0.8)')
              ...
              self.a.Define('PhotonEffSF','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,0,"2018",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF1','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,1,"2018",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
              self.a.Define('PhotonEffSF2','getPhotonSFmvaID(Diphoton_pt,Diphoton_eta,Diphoton_cutBased,1.0,2,"2018",Diphoton_r9,Diphoton_isScEtaEE,Diphoton_isScEtaEB)')
        self.a.Define('DiPhotonCat','getDiPhotonCat(Diphoton_cutBased,1.0)')
#        self.a.Define('DiPhotonCat','getDiPhotonCat(Diphoton_mvaID,0.8)')
#END OF DP EDIT above four lines must be uncommented for TTselection!!!
...
#        self.a.Define('mth','mth1')
        ...
        self.a.Define('HT','abs(pt0)+abs(pt1)+abs(Apt0)+abs(Apt)')
