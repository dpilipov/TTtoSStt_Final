...
#DP EDIT
            ...
            18:['HLT_AK8PFJet60', 'HLT_AK8PFJet80',"HLT_PFHT1050","HLT_AK8PFHT800_TrimMass50","HLT_AK8PFJet500","HLT_AK8PFJet450","HLT_AK8PFJet320","HLT_AK8PFJet420_TrimMass30","HLT_AK8PFHT750_TrimMass50","HLT_AK8PFJet400_TrimMass30","HLT_PFHT500_PFMET100_PFMHT100_IDTight","HLT_DoublePhoton70","HLT_DoublePhoton85"]
        }
...
#        self.a.Define('mth','topchoice2*mth1+(1-topchoice2)*mth2')
    ...
    def OpenForSelection(self,variation):
        ...
        if ('16APV' in self.year):
              ...
              self.a.Define('JetSF1','getSFwp05(Top1Cat,Dijet_pt[0],"2016APV","0")')
              self.a.Define('JetSF2','getSFwp05(Top2Cat,Dijet_pt[1],"2016APV","0")')
              ...
              self.a.Define('JetSF1','getSFwp05(Top1Cat,Dijet_pt[0],"2016","0")')
              self.a.Define('JetSF2','getSFwp05(Top2Cat,Dijet_pt[1],"2016","0")')
              ...
              self.a.Define('JetSF1','getSFwp05(Top1Cat,Dijet_pt[0],"2017","0")')
              self.a.Define('JetSF2','getSFwp05(Top2Cat,Dijet_pt[1],"2017","0")')
        else:
              self.a.Define('Top1Cat','int(Dijet_particleNet_TvsQCD[0]>0.8)')
              self.a.Define('Top2Cat','int(Dijet_particleNet_TvsQCD[0]>0.8)')
              self.a.Define('JetSF1','getSFwp05(Top1Cat,Dijet_pt[0],"2018","0")')
              self.a.Define('JetSF2','getSFwp05(Top2Cat,Dijet_pt[1],"2018","0")')

        SFcorr = genWCorr.Clone('SFcorr',newMainFunc='evalWeight',newType='weight')
        self.a.AddCorrection(SFcorr, evalArgs={'val':'JetSF1','valUp':'JetSF1','valDown':'JetSF1'})
        self.ApplyStandardCorrections(snapshot=False)
        self.a.Define('Dijet_vect_trig','hardware::TLvector(Dijet_pt, Dijet_eta, Dijet_phi, Dijet_msoftdrop)')
        self.a.Define('Top1_vect_trig','hardware::TLvector(Dijet_pt[0], Dijet_eta[0], Dijet_phi[0], Dijet_msoftdrop[0])')
        self.a.Define('Photon1_vect','hardware::TLvector(Diphoton_pt[0],Diphoton_eta[0], Diphoton_phi[0], Diphoton_mass[0])')
...
#DP EDIT SIGNAL SPECIFIC - for 'correct' (signal) vs. 'incorrect' (reflection) - here correct
        self.a.Define('StoAAid0','FindID0StoAA(nGenPart,GenPart_pdgId,GenPart_genPartIdxMother)')
        self.a.Define('topID','FindIDtopWithS(StoAAid0,nGenPart,GenPart_pdgId,GenPart_genPartIdxMother)')
        self.a.Define('gen_vect',"hardware::TLvector(GenPart_pt[topID], GenPart_eta[topID], GenPart_phi[topID], GenPart_mass[topID])")
        self.a.Define('Sgen_vect',"hardware::TLvector(GenPart_pt[StoAAid0], GenPart_eta[StoAAid0], GenPart_phi[StoAAid0], GenPart_mass[StoAAid0])")
        self.a.Define('dRgen','hardware::DeltaR(gen_vect,Sgen_vect)')
#DP EDIT try instead - which top is closer to S!
        self.a.Define('Svec','Photon1_vect+Photon2_vect')
#        self.a.Define('dR0','hardware::DeltaR(Top1_vect,gen_vect)')
#        self.a.Define('dR1','hardware::DeltaR(Top2_vect,gen_vect)')
        self.a.Define('dR0','hardware::DeltaR(Top1_vect,Svec)')
        self.a.Define('dR1','hardware::DeltaR(Top2_vect,Svec)')
        self.a.Define('diff0a','abs(dR0-1.8)')
        self.a.Define('diff0b','abs(dR0-2.5)')
        self.a.Define('ichoice','int(diff0a<diff0b)')
        self.a.Define('diff0c','ichoice*diff0a+(1-ichoice)*diff0b')
        self.a.Define('diff0d','abs(dR0-3.2)')
        self.a.Define('jchoice','int(diff0c<diff0d)')
#        self.a.Define('diff0','diff0c')
        self.a.Define('diff0','jchoice*diff0c+(1-jchoice)*diff0c')
        self.a.Define('diff1a','abs(dR1-1.8)')
        self.a.Define('diff1b','abs(dR1-2.5)')
        self.a.Define('ichoice2','int(diff1a<diff1b)')
        self.a.Define('diff1c','ichoice2*diff1a+(1-ichoice2)*diff1b')
        self.a.Define('diff1d','abs(dR1-3.2)')
        self.a.Define('jchoice2','int(diff1c<diff1d)')
#        self.a.Define('diff1','diff1c')
        self.a.Define('diff1','jchoice2*diff1c+(1-jchoice2)*diff1c')
        self.a.Define('topchoice','int(diff0<diff1)')
#        self.a.Define('topchoice','int(diff0*Dijet_pt_corr[0]*Dijet_pt_corr[0]<diff1*Dijet_pt_corr[1]*Dijet_pt_corr[1])')
#        self.a.Define('topchoice','int(dR1<dR0)')
#        self.a.Define('topchoice','int(dR0<dR1)')
        self.a.Define('mth','topchoice*mth1+(1-topchoice)*mth2')
#        self.a.Define('mth','topchoice*mth1+(1-topchoice)*mth2')
# DP EDIT: for subleading top selection use topchoice2
#        self.a.Define('mth','topchoice2*mth1+(1-topchoice2)*mth2')
#        self.a.Define('mth','mth1')
        ...
        self.a.Define('pt0','Dijet_pt_corr[0]')
        self.a.Define('pt1','Dijet_pt_corr[1]')
#        self.a.Define('HT','abs(pt0)+abs(pt1)+abs(Diphoton_pt[0])+abs(Diphoton_pt[1])')
        self.a.Define('HT','abs(pt0)+abs(pt1)')
        return self.a.GetActiveNode()
