import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_HT0_Data_16APV.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_HT0_ttbar_16APV.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_HT0_VJets_16APV.root','read')
f3  = ROOT.TFile.Open('rootfiles/THselection_HT0_QCD_16APV.root','read')
# get the histos
...
h31 = f3.Get("MtpvMs_TvsQCD_cutBased_SR_pass__nominal")
h33 = f3.Get("MtpvMs_TvsQCD_cutBased_CR_pass__nominal")
h34 = f3.Get("MtpvMs_TvsQCD_cutBased_CR_fail__nominal")
...
c.Print("outputSelectionDataBackgroundM_16APV.pdf")  # save it to the pdf
