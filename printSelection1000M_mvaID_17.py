import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1000x100_17.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1000x200_17.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA1000x300_17.root','read')
# get the histos
...
c.Print("outputSelection1000M_mvaID_17.pdf")  # save it to the pdf
