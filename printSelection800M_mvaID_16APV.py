import ROOT
f = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA800x100_16APV.root','read')
f1 = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA800x200_16APV.root','read')
f2  = ROOT.TFile.Open('rootfiles/THselection_mvaID_HT0_StoAA800x300_16APV.root','read')
# get the histos
...
h1.SetTitle("800-100: SR pass")
h3.SetTitle("800-100: CR pass")
h4.SetTitle("800-100: CR fail") 
...
h11.SetTitle("800-200: SR pass")
h13.SetTitle("800-200: CR pass")
h14.SetTitle("800-200: CR fail")
...
h21.SetTitle("800-300: SR pass")
h23.SetTitle("800-300: CR pass")
h24.SetTitle("800-300: CR fail")
...
c.Print("outputSelection800M_mvaID_16APV.pdf")  # save it to the pdf
