...
def test_make(SRorCR):
    ...
    for f,l,p in [_get_other_region_names(r) for r in twoD.ledger.GetRegions() if 'fail' in r]:
        ...
        # create binned distribution for the fail region
        ...
        for opt_name, opt in _rpf_options.items():
            # Fail->Loose will be given by one of these TFs
...
if __name__ == "__main__":
    ...
    #test_GoF('CR', '1800-125', '1x0', condor=False)
    test_GoF_plot('CR', '1800-125', '1x0')
